...
public class StringUtils {
    ...
    public static String ERROR_LOGIN_USERNAME_OR_PASSWORD = "用户名或者密码错误";
    public static String REQUIRED_USERNAME_OR_PASSWORD = "缺少用户名或者密码";
    public static String USER_DO_NOT_EXIST = "查询用户不存在";
